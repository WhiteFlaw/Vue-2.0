...
function BoxEditor(parentUi, boxEditorManager, viewManager, cfg, boxOp, 
    ...
    this.name=name;
    let uiTmpl = document.getElementById("sub-views");
    let tmpui = uiTmpl.cloneNode(true);  //sub-views
...
function BoxEditorManager(parentUi, viewManager, objectTrackView, 
    ...
    this._addToolBox = function(){
        let template = document.getElementById("batch-editor-tools-wrapper");
        let tool = template.cloneNode(true);
